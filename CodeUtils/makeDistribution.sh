...
filesFrom['Images']="images/Gear_LogicProbe.png:images/Gear_VGA+LogicProbe.png:images/Gear_CogView_PASMRunning.png:images/Gear_CogView_SpinRunning.png:images/Gear_CogView_Stop.png"
