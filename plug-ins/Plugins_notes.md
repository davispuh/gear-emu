...
### B) Plugin API and useful methods to create your own plugins
...
The initial template is full detailed in [PluginTemplate.cs](Gear/Resources/../../../Gear/Resources/PluginTemplate.cs), but the outline is:
...
//Class name of your plugin. You must change it to avoid conflicts with others.
...
**Warning:**
To assure the correct correct operation of the plugin system, you shouldn't change the parameters of any predefined method: neither the names or the types. Also you must not add other parameters.
