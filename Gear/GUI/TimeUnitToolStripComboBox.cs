 ...
 * --------------------------------------------------------------------------------
 * TimeUnitToolStripComboBox.cs
 * ToolStripCombobox specialization for time unit management.
 * --------------------------------------------------------------------------------
...
namespace Gear.GUI
{
    ...
    public partial class TimeUnitToolStripComboBox : ToolStripComboBox, Gear.Utils.ITimeUnitMgmt
    {
        ...
        public TimeUnitToolStripComboBox() : base()
        {
            Mgmt = new TimeUnitMgmt(this.ComboBox);
            InitializeComponent();
        }
