...
namespace Gear.Propeller
{
    partial class Spin
    {
        /// <summary>Declaration of P1 %Spin Math instructions.</summary>
        /// @version v22.05.01 - Fix security warning CA2105: 'Array fields
        /// should not be read only', adopting ReadOnlyCollection static
        /// object as storage.
        public static readonly ReadOnlyCollection<MathInstruction> MathInstructions =
            new ReadOnlyCollection<MathInstruction>(new[]
            {
